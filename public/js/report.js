            ...
            fetch(geocodeUrl)
                ...
                .then(data => {
                    if (data.results.length > 0) {
                        ...
                        // Loop through the address components to find the city, neighborhood, or other relevant area name
                        for (const component of addressComponents) {
                            if (component.types.includes('locality')) {
                                ...
                                // State or Province (as a fallback if other options are not available)
                                locationName = component.long_name;
                            }
                        }
